...
class USFALearner(acme.Learner):
  """R2D2 learner."""
  ...
  def __init__(self,
    ...
    def loss(
      ...
      if burn_in_length:
        ...
        key_grad, key1, key2, key3, key4 = jax.random.split(key_grad, 5)
        _, online_state = unroll.apply(params, key1, burn_obs, online_state, key2)
        _, target_state = unroll.apply(target_params, key3, burn_obs,
                                       target_state, key4)
      ...
      key1, key2, key3, key4 = jax.random.split(key_grad, 4)
      online_q, _ = unroll.apply(params, key1, data.observation, online_state, key2)
      target_q, _ = unroll.apply(target_params, key3, data.observation, target_state, key4)
