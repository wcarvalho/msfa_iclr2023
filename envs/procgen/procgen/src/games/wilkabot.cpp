...
const std::string NAME = "wilkabot";
...
class WilkaBotGame : public BasicAbstractGame {
  public:
    float min_dim = 0.0f;
    ...
    void game_reset() override {
        ...
        int num_good = rand_gen.randn(7) + 7;
        int num_bad = rand_gen.randn(7) + 7;
...
REGISTER_GAME(NAME, WilkaBotGame);
