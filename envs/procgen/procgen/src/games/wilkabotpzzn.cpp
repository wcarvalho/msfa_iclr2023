...
const std::string NAME = "wilkabotpzzn";
...
class WilkaBotPZZNGame : public BasicAbstractGame {
  public:
    float min_dim = 0.0f;
    ...
    void game_reset() override {
        ...
        int num_neutral = rand_gen.randn(10) + 10;
        int num_bad = rand_gen.randn(10) + 5;
        ...
        for (auto ent : entities) {
            if (ent->type == GOOD_OBJ || ent->type == BAD_OBJ || ent->type == NEUTRAL_OBJ) {
...
REGISTER_GAME(NAME, WilkaBotPZZNGame);
