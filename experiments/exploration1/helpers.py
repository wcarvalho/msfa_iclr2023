...
from experiments.exploration1 import configs
from experiments.common import agent_loading, nets as common_nets
...
def load_agent_settings(agent, env_spec, config_kwargs=None, setting='small'):
  ...
  # USFA + cumulants from FARM + Q-learning
    ...
    # NetworkCls=nets.exploration1 # default: 2M params
