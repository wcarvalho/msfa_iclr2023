...
def main(_):
  env = helpers.make_environment_sanity_check(evaluation=False, simple=FLAGS.super_simple,agent=FLAGS.agent,nowalls=False, one_room=False, deterministic_rooms=True) #3 objects if super simple, otherwise 2-3 types
