"""Run Successor Feature based agents and baselines on 
  ...
  PYTHONPATH=$PYTHONPATH:$HOME/projects/rljax/ \
    ...
    python debugging/leaks/goto_local.py \
    --agent r2d1
...
def main(_):
  ...
  config, NetworkCls, NetKwargs, LossFn, LossFnKwargs, loss_label, eval_network = helpers.load_agent_settings(FLAGS.agent, env_spec, config_kwargs, setting=FLAGS.env_setting)
